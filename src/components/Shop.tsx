          ...
          {tiers.map((tier, i) => (
            <motion.div
              ...
              className={
                ...
                (tier.popular
                  ? 'bg-gray-900 text-white shadow-2xl ring-2 ring-accent md:scale-105 md:-my-4 md:py-4'
                ...
                <div className="space-y-3 mb-8">
                  {tier.features.map((f) => (
                    <div key={f} className="flex items-center gap-3">
                      <div className={'w-5 h-5 rounded-full flex items-center justify-center shrink-0 ' + (tier.popular ? 'bg-accent' : 'bg-gray-900')}>
